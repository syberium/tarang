...
EnergyTr::EnergyTr()						 
{
	...
	if (global.energy_transfer.turnon) {
		...
		flux_U_grad_Uplus_Uplus.resize(global.energy_transfer.flux.no_spheres+1);          
		flux_U_grad_Uplus_Uminus.resize(global.energy_transfer.flux.no_spheres+1);         
		flux_U_grad_Uminus_Uplus.resize(global.energy_transfer.flux.no_spheres+1);         
		flux_U_grad_Uminus_Uminus.resize(global.energy_transfer.flux.no_spheres+1);        
		flux_Uplus_grad_Uplus_Uplus.resize(global.energy_transfer.flux.no_spheres+1);    
		flux_Uplus_grad_Uplus_Uminus.resize(global.energy_transfer.flux.no_spheres+1);   
		flux_Uminus_grad_Uminus_Uminus.resize(global.energy_transfer.flux.no_spheres+1); 
		flux_Uminus_grad_Uminus_Uplus.resize(global.energy_transfer.flux.no_spheres+1);  


		//Helical decomposition for MHD

		flux_B_grad_Bplus_Uplus.resize(global.energy_transfer.flux.no_spheres+1);          
		flux_B_grad_Bplus_Uminus.resize(global.energy_transfer.flux.no_spheres+1);         
		flux_B_grad_Bminus_Uplus.resize(global.energy_transfer.flux.no_spheres+1);         
		flux_B_grad_Bminus_Uminus.resize(global.energy_transfer.flux.no_spheres+1);        
		flux_Bplus_grad_Bplus_Uplus.resize(global.energy_transfer.flux.no_spheres+1);    
		flux_Bplus_grad_Bplus_Uminus.resize(global.energy_transfer.flux.no_spheres+1);   
		flux_Bminus_grad_Bminus_Uminus.resize(global.energy_transfer.flux.no_spheres+1); 
		flux_Bminus_grad_Bminus_Uplus.resize(global.energy_transfer.flux.no_spheres+1);  

		flux_U_grad_Bplus_Bplus.resize(global.energy_transfer.flux.no_spheres+1);          
		flux_U_grad_Bplus_Bminus.resize(global.energy_transfer.flux.no_spheres+1);         
		flux_U_grad_Bminus_Bplus.resize(global.energy_transfer.flux.no_spheres+1);         
		flux_U_grad_Bminus_Bminus.resize(global.energy_transfer.flux.no_spheres+1);        
		flux_Uplus_grad_Bplus_Bplus.resize(global.energy_transfer.flux.no_spheres+1);    
		flux_Uplus_grad_Bplus_Bminus.resize(global.energy_transfer.flux.no_spheres+1);   
		flux_Uminus_grad_Bminus_Bminus.resize(global.energy_transfer.flux.no_spheres+1); 
		flux_Uminus_grad_Bminus_Bplus.resize(global.energy_transfer.flux.no_spheres+1);  

		flux_B_grad_Uplus_Bplus.resize(global.energy_transfer.flux.no_spheres+1);          
		flux_B_grad_Uplus_Bminus.resize(global.energy_transfer.flux.no_spheres+1);         
		flux_B_grad_Uminus_Bplus.resize(global.energy_transfer.flux.no_spheres+1);         
		flux_B_grad_Uminus_Bminus.resize(global.energy_transfer.flux.no_spheres+1);        
		flux_Bplus_grad_Uplus_Bplus.resize(global.energy_transfer.flux.no_spheres+1);    
		flux_Bplus_grad_Uplus_Bminus.resize(global.energy_transfer.flux.no_spheres+1);   
		flux_Bminus_grad_Uminus_Bminus.resize(global.energy_transfer.flux.no_spheres+1); 
		flux_Bminus_grad_Uminus_Bplus.resize(global.energy_transfer.flux.no_spheres+1);  
