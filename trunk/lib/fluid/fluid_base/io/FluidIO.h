...
public:
	...
	void Init_cond_random_noise(FluidVF& U);
    void Init_cond_random_noise(FluidVF& U, FluidVF& W);
	...
	// void Output_reduced_real_field(FluidVF& U, FluidVF& W);
	...
	void Output_shell_spectrum(FluidVF& U, FluidVF& W, FluidVF& helicalU, FluidVF& helicalW);
