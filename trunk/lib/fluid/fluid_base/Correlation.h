...
public:
	...
	//!  Wavenumber corresponded to shell k
	static  Array<Real,1>		shell_kn;
	static  Array<Real,1>		shell_knf;
	...
	static Real Get_energy_injection_rate(FluidVF &U);
	static Real Get_injection_rate(FluidVF &U, FluidVF &W);
	
	static void Compute_shell_spectrum(FluidVF& U);
	static void Compute_shell_spectrum(FluidVF& U, FluidVF& W);
	static void Compute_shell_spectrum_dissk(FluidVF& U, FluidVF& W);
	static void Compute_shell_spectrum_dissk_2nu(FluidVF& U, FluidVF& W);
	...
	static void Compute_shell_spectrum_helicity_MHD(FluidVF& U);
	...
	static void Compute_force_shell_spectrum(FluidVF& U, FluidVF& W);
