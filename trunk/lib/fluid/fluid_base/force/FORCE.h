...
public:
	...
	void Const_magnetic_energy_supply_alpha_beta(FluidVF& U, FluidVF& W, int lx, int ly, int lz, Real alpha, Real beta, bool add_flag);
	void Const_energy_supply_alpha_beta_gamma(FluidVF& U, FluidVF& W, int lx, int ly, int lz, Real alpha, Real beta, Real gamma, bool add_flag);
	void Const_magnetic_energy_supply_alpha_beta_gamma(FluidVF& U, FluidVF& W, int lx, int ly, int lz, Real alpha, Real beta, Real gamma, bool add_flag);
	...
	void Force_energy_crosshelicity_supply_or_level_basic_assign(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real para1, Real para2, Real para3);
	void Force_energy_crosshelicity_supply_or_level_basic_add(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real para1, Real para2, Real para3);
	void Force_magnetic_energy_crosshelicity_supply_or_level_basic_assign(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real para1, Real para2, Real para3);
	void Force_magnetic_energy_crosshelicity_supply_or_level_basic_add(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real para1, Real para2, Real para3);
	...
	void Force_energy_crosshelicity_supply_or_level_basic(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real para1, Real para2, Real para3, bool add_flag);
	void Force_magnetic_energy_crosshelicity_supply_or_level_basic(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real para1, Real para2, Real para3, bool add_flag);
	Real Compute_energy_injection(FluidVF& U);
	
	void Compute_force_crosshelicity_supply(FluidVF& U, FluidVF& W);
	
	//	RANDOM FORCE TITOV RED.
	void Compute_force_random_direction(FluidVF& U, FluidVF& W);
	void Kinetic_force_random_direction_assign(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real Au, Real Bu, Real Cu);
	void Magnetic_force_random_direction_assign(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real Ab, Real Bb, Real Cb);
	/*NEW WRAP*/
	void Main_random_direction_forcing(FluidVF& U, FluidVF& W);
	void Compute_simple_kinetic_random_forcing_addition_shell_distr(FluidVF& U, FluidVF& W, Real k0, Real k1, Real Au);
	/*NEW WRAP*/
	void Compute_random_crosshelical_forcing(FluidVF& U, FluidVF& W);
	void Kinetic_and_magnetic_random_crosshelical_forcing_assign(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real Au, Real Bu, Real Cu, Real Cb);

	void Compute_random_crosshelical_forcing_addition(FluidVF& U, FluidVF& W);
	void Kinetic_and_magnetic_random_crosshelical_forcing_addition(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real Au, Real Bu, Real Cu, Real Cb);

	void Compute_random_helical_forcing_Stepanov_Titov(FluidVF& U, FluidVF& W);
	void Kinetic_random_helical_forcing_Stepanov_Titov_assign(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real Au, Real Bu);
	void Magnetic_random_helical_forcing_Stepanov_Titov_assign(FluidVF& U, FluidVF& W, Real inner_radiusM, Real outer_radiusM, Real Ab, Real Bb);

	void Compute_random_helical_forcing_Stepanov_Titov_mod(FluidVF& U, FluidVF& W);
	void Kinetic_random_helical_forcing_Stepanov_Titov_assign_mod(FluidVF& U, FluidVF& W, Real inner_radius, Real outer_radius, Real Au, Real Bu);
	void Magnetic_random_helical_forcing_Stepanov_Titov_assign_mod(FluidVF& U, FluidVF& W, Real inner_radiusM, Real outer_radiusM, Real Ab, Real Bb);

	//	END of RANDOM FORCE TITOV RED.

	// HELICAL DECOMPOSITION, DETERMINED FORCE

	void Compute_force_hydro_helical_decompose(FluidVF& U);
	void Compute_force_MHD_helical_decompose(FluidVF& U, FluidVF& W);
	void Compute_force_hydro_helical_decompose_addition(FluidVF& U, Real inner_radius, Real outer_radius, Real Au, Real Bu, Real Cu, int MHD_switch);
	
	void Compute_force_MHD_helical_decompose_shell_distribution(FluidVF& U,FluidVF& W);
	void Compute_force_MHD_helical_decompose_shell_distribution_differ_scales(FluidVF& U,FluidVF& W);
	void Compute_force_hydro_helical_decompose_addition_shell_distribution(FluidVF& U, Real inner_radius, Real outer_radius, Real Au, Real Bu, Real Cu, int MHD_switch);

	void Compute_force_MHD_helical_decompose_with_crosshel(FluidVF& U,FluidVF& W);
	void Compute_force_helical_decompose_crosshel_addition(FluidVF& U, Real inner_radius, Real outer_radius, Real Au, Real Bu, Real Cu, int MHD_switch, FluidVF& W);

	// COMBINATION OF RANDOM CROSS-HELICAL INJECTION AND HELICAL DECOMPOSITION FORCE

	void Compute_random_crosshelical_forcing_addition_plus_helical_decompose_kinetic_helicity(FluidVF& U, FluidVF& W);
	void Compute_random_crosshelical_forcing_addition_plus_helical_decompose_magnetic_helicity(FluidVF& U, FluidVF& W);
	void Compute_random_crosshelical_forcing_addition_plus_helical_decompose_kinetic_magnetic_helicity(FluidVF& U, FluidVF& W);

	// END of HELICAL DECOMPOSITION, DETERMINED FORCE
