...
void Global::force::Print(int my_level)
{
    ...
    if(force_alpha_is_adaptive)     cout<<'\n'<<Indent(my_level+1)<<"force_I0: "<<force_I0;                                     else cout<<'\n'<<Indent(my_level+1)<<"force_I0: "<<"alpha_u isn't adaptive";
    if(force_beta_is_adaptive)      cout<<'\n'<<Indent(my_level+1)<<"force_I0_helical: "<<force_I0_helical;                     else cout<<'\n'<<Indent(my_level+1)<<"force_I0_helical: "<<"beta_u isn't adaptive";
    if(force_gamma_is_adaptive)     cout<<'\n'<<Indent(my_level+1)<<"force_I0_crosshelical: "<<force_I0_crosshelical;           else cout<<'\n'<<Indent(my_level+1)<<"force_I0_crosshelical: "<<"gamma_u isn't adaptive";
    if(mag_force_alpha_is_adaptive) cout<<'\n'<<Indent(my_level+1)<<"mag_force_I0: "<<mag_force_I0;                             else cout<<'\n'<<Indent(my_level+1)<<"mag_force_I0: "<<"alpha_b isn't adaptive";
    if(mag_force_beta_is_adaptive)  cout<<'\n'<<Indent(my_level+1)<<"mag_force_I0_helical: "<<mag_force_I0_helical;             else cout<<'\n'<<Indent(my_level+1)<<"mag_force_I0_helical: "<<"beta_b isn't adaptive";
    if(mag_force_gamma_is_adaptive) cout<<'\n'<<Indent(my_level+1)<<"mag_force_I0_crosshelical: "<<mag_force_I0_crosshelical;   else cout<<'\n'<<Indent(my_level+1)<<"mag_force_I0_crosshelical: "<<"gamma_b isn't adaptive";
