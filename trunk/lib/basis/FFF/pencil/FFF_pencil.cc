...
FFF_PENCIL::FFF_PENCIL()
{
	...
	// global.temp_array.ForceA1.resize(shape_complex_array);
	// global.temp_array.ForceA2.resize(shape_complex_array);
	// global.temp_array.ForceA3.resize(shape_complex_array);
	
	// global.temp_array.ForceB1.resize(shape_complex_array);
	// global.temp_array.ForceB2.resize(shape_complex_array);
	// global.temp_array.ForceB3.resize(shape_complex_array);
	
	// global.temp_array.ForceC1.resize(shape_complex_array);
	// global.temp_array.ForceC2.resize(shape_complex_array);
	// global.temp_array.ForceC3.resize(shape_complex_array);
