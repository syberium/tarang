...
public:
 ...
 //    virtual Real Get_local_energy_XZ_plane
	...
	virtual void Compute_local_shell_spectrum_helicity_MHD
	(
	 Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az,
	 Array<Real,1> local_H1k1, Array<Real,1> local_H1k2, Array<Real,1> local_H1k3,
	 Array<Real,1> local_H1k_count
	...
	virtual void Compute_shell_spectrum_helicity_MHD
	(
	 Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az,
	 Array<Real,1> H1k1, Array<Real,1> H1k2, Array<Real,1> H1k3
	) = 0;
	...
	virtual Real Get_local_Sn(Array<Complex,3> A, Array<Complex,3> B, Real n, Real start_shell, Real end_shell);
	virtual Real Get_total_Sn(Array<Complex,3> A, Array<Complex,3> B, Real n, Real start_shell, Real end_shell);
	
	virtual void Compute_local_shell_spectrum(Array<Complex,3> A, int n, Array<Real,1> local_Sk, Array<Real,1> local_Sk_count, Array<Real,1> local_k);
	virtual void Compute_shell_spectrum(Array<Complex,3> A, int n, Array<Real,1> Sk, Array<Real,1> k);

	virtual void Compute_local_shell_spectrum(Array<Complex,3> A,  Array<Complex,3> B, int n, Array<Real,1> local_Sk, Array<Real,1> local_Sk_count, Array<Real,1> local_k);
	virtual void Compute_shell_spectrum(Array<Complex,3> A, Array<Complex,3> B, int n, Array<Real,1> Sk, Array<Real,1> k);

	virtual void Compute_local_shell_spectrum_force(Array<Complex,3> A, int n, Array<Real,1> local_Sk, Array<Real,1> local_Sk_count, Array<Real,1> local_k);
	virtual void Compute_shell_spectrum_force(Array<Complex,3> A, int n, Array<Real,1> Sk, Array<Real,1> k);

	virtual void Compute_local_shell_spectrum_force(Array<Complex,3> A,  Array<Complex,3> B, int n, Array<Real,1> local_Sk, Array<Real,1> local_Sk_count, Array<Real,1> local_k);
	virtual void Compute_shell_spectrum_force(Array<Complex,3> A, Array<Complex,3> B, int n, Array<Real,1> Sk, Array<Real,1> k);
