...
/**********************************************************************************************
	...
	IMPLEMENTED ONLY FOR FFF!!!
	Not for 2D
***********************************************************************************************/

void SSF_PENCIL::Compute_local_shell_spectrum_helicity_MHD
(
	Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, 
	Array<Real,1> local_H1k1, Array<Real,1> local_H1k2, Array<Real,1> local_H1k3, 
	Array<Real,1> local_H1k_count
...
void SSF_PENCIL::Compute_shell_spectrum_helicity_MHD
(
	Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, 
	Array<Real,1> H1k1, Array<Real,1> H1k2, Array<Real,1> H1k3
)	
{
	...
	H1k2 = 0;
	H1k3 = 0;
	cerr<<"SSF_PENCIL::Compute_shell_spectrum_helicity_MHD(Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az,Array<Real,1> H1k1, Array<Real,1> H1k2, Array<Real,1> H1k3) : Not implemented for SSF basis" << endl;
}
